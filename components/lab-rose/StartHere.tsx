...
const paths = [
  {
    ...
    desc: 'Sen, kortyzol, poranna rutyna. Dla mam śpiących < 6h, które wstają zmęczone.',
    cta: 'Ścieżka energii',
  ...
  },
  {
    ...
    desc: 'Cykl, tarczyca, hormony stresu. Dla kobiet po 30. które czują że "coś nie gra".',
  ...
  },
  {
    ...
    desc: 'Longevity, post przerywany, biomarkery. Dla planujących zdrowie na dekady.',
