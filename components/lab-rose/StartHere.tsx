...
const paths = [
  ...
  },
  {
    ...
    desc: 'Cykl, tarczyca, metabolizm. Dla kobiet, które czują, że ich ciało straciło kobiecą równowagę, zmagają się z PMS, mgłą mózgową lub oporną wagą.',
  ...
  },
  {
    ...
    desc: 'Toksyny budowlane, elektrosmog, jakość wody i powietrza. Dla osób, które rozumieją, że cztery ściany to najważniejsze środowisko kształtujące naszą biologię.',
  ...
  },
  {
    ...
    desc: 'Rozwój mózgu, odporność, nawyki zdrowotne. Dla rodziców, którzy wiedzą, że najlepszy prezent dla dziecka to fundament zdrowia zbudowany w pierwszych latach życia.',
