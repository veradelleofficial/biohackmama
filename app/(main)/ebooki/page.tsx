  ...
  return (
    <main className="pb-14 md:pb-20">
      ...
      <div className="container -mt-8 md:-mt-14 relative z-40">
        ...
        >
          <p className="text-xs font-semibold uppercase tracking-widest" style={{ color: 'rgba(45, 58, 45,0.45)' }}>
        ...
        >
          ...
          <h2 className="font-heading text-3xl md:text-4xl font-normal tracking-heading mb-4" style={{ color: '#2D3A2D' }}>
            Już wkrótce
          </h2>
          <p className="text-base font-light max-w-md mx-auto leading-relaxed" style={{ color: 'rgba(45, 58, 45,0.70)' }}>
          ...
          <a
            ...
            style={{ background: '#4F5E44', boxShadow: '0 4px 16px rgba(79, 94, 68,0.30)' }}
          >
